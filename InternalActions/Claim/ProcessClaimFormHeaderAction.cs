...
namespace HAI_Selenium.InternalActions.Claim
{
    internal class ProcessClaimFormHeaderAction : WorkflowStepBase
    {
        ...
        protected override void PerformStep(IWebDriver driver)
        {
            ...
            try
            {
                var formHeaderData = Context.Get<RequestInvoiceFormHeaderData>("FormHeaderData");
                ...
                externalIDInput.SendKeys(formHeaderData.patientPolicyNumber);
                ...
                var indexedServiceDateRequests = formHeaderData.patientDiagnosisCodes.Select((diagnosisCode, index) => new { diagnosisCode, index });
                ...
                authNumberInput.SendKeys(formHeaderData.authNumber);
