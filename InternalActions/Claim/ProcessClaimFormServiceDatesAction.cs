...
namespace HAI_Selenium.InternalActions.Claim
{
    ...
    {
        protected List<ServiceDateFormData> ServiceDatesFormData { get; init; }
        protected int BatchNumber { get; init; }

        internal ProcessFormServiceDatesAction(List<ServiceDateFormData> serviceDatesFormData, int batchNumber)
        {
